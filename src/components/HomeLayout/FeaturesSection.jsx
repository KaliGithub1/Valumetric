    ...
    <section className="features-section" id="features-section">
      <div className="max-width container">
        <header>
          <FadeUpAnimation>
            <h6>
              Why Your Project Needs <span>VoluMetric</span>
            </h6>
          ...
          <main className="bento-grid--container">
            <article>
              ...
              <div className="content-container content--2" ref={speedTrigger}>
                <div className="text-content">
                  ...
                  <p>
                    Don’t waste months waiting for growth. With VoluMetric,
            ...
            <article className="middle--content">
              <div className="content-container content--3" ref={coinTrigger}>
                <div className="text-content">
                  <h3>
                    Tailored to Top Chains – Built for XRP and SUI
                  </h3>
                  <p>
                    No generic solutions here. VoluMetric is specifically
                    engineered for XRP and SUI projects, ensuring
              ...
              <div className="content--4">
                ...
                <div className="sub__content-container sub__content--2">
                  <div className="text-content">
                    ...
                    <p>
                      When you work with VoluMetric, you gain access to an
            ...
            <article>
              <div className="content-container content--5" ref={scaleTrigger}>
                <div className="text-content">
                  ...
                  <p>
                    From ambitious startups to market leaders, VoluMetric
