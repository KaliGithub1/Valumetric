      ...
      <div className="referral-wrapper max-width">
        <main className="section-flex">
          <div className="text-description">
            <FadeUpAnimation>
              <header>
                <h3 mb-8>VoluMetric Referrals</h3>
                <h3>Earn Big, Effortlessly</h3>
              </header>
              <h4>
                Share your unique referral link and earn a 10% commission on
                every package purchased by your referrals. The more referrals
                you bring, the more you earn. Turn your network into a steady
                income stream!
              </h4>
              ...
              <article className="referral--benefits">
                ...
                <div className="benefit--item">
                  ...
                  <p>
                    Start sharing your referral link today and watch your
                    earnings grow with VoluMetric.
                  </p>
                </div>
              </article>
