    ...
    <footer>
      <div className="footer-wrapper max-width">
        ...
        <article className="disclaimer--wrapper">
          <h4>VoluMetric Disclaimer</h4>
          <p>
            VoluMetric is an automated trading bot designed for educational and
            ...
            operators of VoluMetric assume no responsibility for any misuse or
            misleading actions by users that may impact their audience or
            project. Always use VoluMetric responsibly and in accordance with
        ...
        <div className="copyright-container">
          <p>2025 VoluMetric Inc. All rights reserved</p>
        </div>
      </div>
    </footer>
  );
